...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Yusicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"yusicointools.com", "172.20.209.111"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"yusicointools.com", "testnet-seed.yusicointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Yusicoin is probably already running."), addrBind.ToString().c_str());
        else
